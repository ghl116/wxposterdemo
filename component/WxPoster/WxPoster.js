...
Component({
  ...
  data: {
    ...
    pageQRCodeImgUrl: "",
    settingMsg: { bgImgTempPath: "/images/post1.jpeg", bgImgW: 1080, nickName: "", slogan: "长按图片，精彩在里", useSetting: true, showTitle: true, whRatio: 0.6, textColor: "white"},
  ...
  methods: {
    ...
    _resetSettingMsg: function() {
      console.log('_resetSettingMsg')
      var that = this;
      that.data.settingMsg.bgImgTempPath = "/images/post2.jpg";
    ...
    _createCanvasImgByLocalImg: function() {
      ...
      context.draw(false, setTimeout(function (e) {
        ...
        console.log(that.data.user_info.avatarUrl)
        wx.downloadFile({
    ...
    _onStartGeneratePoster: function(e) {
      var that = this;
      console.log("_onStartGeneratePoster",e,that.data.settingMsg);
      wx.getUserInfo({
        success: function (res) {
          that.setData({
            user_info: res.userInfo
